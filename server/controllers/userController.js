...
//       res.status(400).json({ message: 'Invalid password (at least 1 digit, 1 lowercase, 1 uppercase)'});
//       throw new Error('Invalid password (at least 1 digit, 1 lowercase, 1 uppercase)')
//     }
