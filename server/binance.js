...
var socket = socketio('http://3.8.190.201/coins')
...
const resubsctibe = (subscribeCoins) => {
  socket.emit('subscribe', subscribeCoins)
  return (args) => {
    socket.emit('unsubscribe', subscribeCoins)
    subscribeCoins = args
    socket.emit('subscribe', subscribeCoins)  
  }
}

const reSub = resubsctibe([
  { 
      "symbol" : "XLM" 
  },
  {
