                    ...
                    {filteredData
                      ...
                      .map((elem) => (
                        <button
                          ...
                          className="listElem"
                        >
                          <span style={{display:'flex',justifyContent:'center', alignItems:'center'}}><img src="./icons/watchlist_dark.png" className="addToWatch" onClick={()=>changeWatchlist("remove",elem.symbol)}/>{elem.rank}</span>
